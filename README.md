...
A work-in-progress decompilation of Mario Party 7.
...
- Copy your game's disc image to `orig/GP7E01`.
...
- Configure:
  ...
  To use a version other than `GP7E01` (USA), specify it with `--version`.
